...
def parse_args():
    ...
    parser.add_argument("--load_format", type=str, default=None, help="[dummy, state_dict, None]")
...
def benchmark_vllm(model, tensor_parallel, num_queries, warmup, prompt_lengths, max_prompt_length, max_new_tokens, quantization, load_format):
